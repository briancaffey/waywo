...
| `Nemotron-Content-Safety-Reasoning-4B` | Content Safety | 4B | harmful/unharmful classification |
...
A fourth model, **Nemotron-Content-Safety-Reasoning-4B**, runs as a guardrail on chat inputs and outputs. It classifies user prompts and LLM responses as harmful or unharmful based on a custom safety policy. It is served via vLLM on a separate GPU.

See [Content Safety](/content-safety/overview) for details on the safety policy and integration.
